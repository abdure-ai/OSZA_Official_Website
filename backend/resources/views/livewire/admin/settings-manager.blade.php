<div>
        ...
        @if($showSuccess)
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
                        class="mb-8 bg-green-50 border-l-4 border-green-500 text-green-800 p-4 rounded-r-2xl flex items-center gap-3 shadow-md transition-all duration-500">
                        <svg class="w-6 h-6 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <span class="font-bold text-sm">Settings updated successfully!</span>
                </div>
        @endif
